...
sys.path.insert(0, "../../")
import signal
from ENC import Encoder8To3


class TestEncoder8To3:
    def test_ENC_8to3_000000000(self):
        enc = Encoder8To3(0, 0, 0, 0, 0, 0, 0, 0, 0)
