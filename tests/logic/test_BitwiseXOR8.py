...
class TestBitwiseXOR8:
    def test_BitwiseXOR8(self):
        ...
        a = bw.logic.BitwiseXOR8(a_bus, b_bus, o_bus)
        ...
        assert o_bus.wire_values == (0, 1, 0, 1, 0, 1, 0, 1)
        ...
        assert o_bus.wire_values == (0, 0, 0, 0, 1, 1, 1, 1)
        ...
        assert o_bus.wire_values == (0, 1, 0, 1, 1, 0, 1, 0)
