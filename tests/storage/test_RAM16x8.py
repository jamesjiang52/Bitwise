...
class TestRAM16x8:
    def test_RAM16x8(self):
        ...
        data_bus.wire_values = (0, 0, 0, 0, 0, 0, 0, 1)
        address_bus.wire_values = (0, 0, 0, 0)
        ...
        data_bus.wire_values = (1, 0, 1, 0, 1, 0, 1, 0)
        address_bus.wire_values = (1, 0, 0, 0)
        clock.value = 0
        clock.value = 1
        assert output_bus.wire_values == (1, 0, 1, 0, 1, 0, 1, 0)

        data_bus.wire_values = (1, 1, 1, 1, 1, 1, 1, 0)
        address_bus.wire_values = (1, 1, 1, 1)
        clock.value = 0
        clock.value = 1
